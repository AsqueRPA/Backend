...
async def run() -> None:
    async with async_playwright() as playwright:
        ...
        for index, card_title in enumerate(card_titles):
            ...
            await page.wait_for_timeout(2000) # Wait for the modal to close, adjust as needed
        ...
        await click_card_by_index(page, card_index)
...
def findItem(dict, search_name):
    ...
    print('gpt reply: ' + message_text) 
    return int(message_text)

async def click_card_by_index(page, index):
    ...
    await page.wait_for_selector(cards_selector)
